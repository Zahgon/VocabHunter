...
public enum FilterFileModeView {
    ...
    SESSION_KNOWN(FILTER_MAIN_LISTS_TYPE_KNOWN, null, CHECK_CIRCLE, null, "filterKnownIcon"), SESSION_SEEN(FILTER_MAIN_LISTS_TYPE_BOTH, CHECK_CIRCLE, TIMES_CIRCLE, "filterKnownIcon", "filterUnknownIcon"), GRID(FILTER_MAIN_LISTS_TYPE_LIST, null, TABLE, null, "filterGridIcon");
